...
#if 0
/*tips:romfs*/
	if(dfs_mount(RT_NULL,"/romfs","rom",0,(const void*)0x1a0000) == 0)
		rt_kprintf("romfs file system initialized\r\n");
	else
		rt_kprintf("romfs file system failed\r\n");
#endif

#if 0
/*tips:fatfs*/
	rt_hw_flash_disk_readonly_init("flash0", 0x1ba000, 512,(256 - 1)*1024);
...
#if 0
/*tips share flash space with download area*/
