					    ...
					    int show_errors)
{
	...
	case OUI_MICROSOFT:
		...
		case 4:
			...
			break;
		default:
			os_null_printf("Unknown Microsoft "
				   "information element ignored "
				   "(type=%d len=%lu)",
	...
	case OUI_BROADCOM:
		...
		case VENDOR_VHT_TYPE:
			...
			break;
		default:
			os_null_printf("Unknown Broadcom "
				   "information element ignored "
				   "(type=%d len=%lu)",
				   pos[3], (unsigned long) elen);
			return -1;
	...
	default:
		os_null_printf("unknown vendor specific "
