                                     ...
                                     kernel_task_id_t const src_id)
{
    ...
    if(ble_scan_list.scan_count < appm_get_max_scan_nums())
    {
        ...
        if(i == ble_scan_list.scan_count)
        {
            ...
            bk_printf("adv type = %x  :%s\r\n",ble_scan_list.info[ble_scan_list.scan_count].adv_type, 
            ...
            bk_printf("adv rssi = %d\r\n", (int8_t)ble_scan_list.info[ble_scan_list.scan_count].rssi);
            bk_printf("adv addr = %02x:%02x:%02x:%02x:%02x:%02x\r\n",
                ble_scan_list.info[ble_scan_list.scan_count].adv_addr[0],ble_scan_list.info[ble_scan_list.scan_count].adv_addr[1],ble_scan_list.info[ble_scan_list.scan_count].adv_addr[2],
                ble_scan_list.info[ble_scan_list.scan_count].adv_addr[3],ble_scan_list.info[ble_scan_list.scan_count].adv_addr[4],ble_scan_list.info[ble_scan_list.scan_count].adv_addr[5]);
            bk_printf("adv addr type = %02x\r\n",ble_scan_list.info[ble_scan_list.scan_count].addr_type);
