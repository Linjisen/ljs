...
typedef struct _sdio_entity_
{
    ...
    SDIO_NODE_T snode[SDIO_COUNT];

    LIST_HEADER_T tx_dat;		/* tx data from user */
    LIST_HEADER_T txing_list;

    LIST_HEADER_T rx_dat;		/* rx data from host */
    LIST_HEADER_T rxing_list;
    FUNCPTR rx_cb;				/* rx callback function */

    LIST_HEADER_T free_nodes;	/* list of SDIO_NODE_T */
